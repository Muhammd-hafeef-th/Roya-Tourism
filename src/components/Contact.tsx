          ...
          >
            ...
            >
              ...
              <div className="mt-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                <button
                  type="submit"
                  className="inline-flex w-full sm:w-auto items-center justify-center gap-3 px-6 py-3.5 rounded-2xl bg-gradient-to-r from-[#c9a84c] to-[#f0d98a] text-white font-semibold shadow-lg hover:-translate-y-1 transition-all duration-300"
                >
                  <Send size={16} />
                  Send Inquiry
                </button>
