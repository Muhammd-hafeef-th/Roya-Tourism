...
export const domesticPackages = [
  ...
  },
  {
    ...
    description: 'Experience Paradise on Earth surrounded by snow-capped peaks, vibrant gardens, and pristine lakes.',
  ...
  },
  {
    ...
    description: 'Discover untouched coral reefs and crystal-clear turquoise lagoons in India’s tropical paradise.',
  ...
  },
  {
    ...
    description: 'Explore magnificent forts, royal palaces, and the timeless beauty of Rajasthan.',
  ...
  },
  {
    ...
    stars: 4,
    hotel: 'Beachfront Resort',
    description: 'Relax on golden beaches and enjoy vibrant nightlife with luxury coastal experiences.',
  ...
  },
  {
    ...
    description: 'Wander through endless tea plantations and misty green hills in Munnar.',
    highlights: ['Tea Plantation Tour', 'Misty Valley', 'Adventure Trekking', 'Mountain Views'],
    image: 'https://images.unsplash.com/photo-1506744038136-46273834b3fb?q=80&w=1600&auto=format&fit=crop',
    badge: 'Mountain Escape',
    isSpecialized: false,
  },
  {
    destination: 'Jaisalmer Desert',
    country: 'India',
    state: 'Rajasthan',
    duration: '5 Days / 4 Nights',
    price: '$599',
    priceNote: 'per person',
    stars: 4,
    hotel: 'Desert Camp Luxury',
    description: 'Experience golden sand dunes, camel safaris, and magical desert sunsets.',
    highlights: ['Camel Safari', 'Sunset View', 'Folk Dance', 'Sand Dunes'],
  ...
  },
  {
    ...
    description: 'Witness the timeless beauty of the Taj Mahal and Mughal architecture.',
    highlights: ['Taj Mahal', 'Agra Fort', 'Night Illumination', 'Local Bazaar'],
    image: 'https://images.unsplash.com/photo-1564507592333-c60657eea523?q=80&w=1600&auto=format&fit=crop',
    badge: 'Must See',
    isSpecialized: false,
  },
  {
    destination: 'Shimla Snow Trail',
    country: 'India',
    ...
    description: 'Adventure through snowy mountains, pine forests, and scenic hill stations.',
    highlights: ['Snow Activities', 'Mall Road', 'Jakhoo Temple', 'Nature Walks'],
  ...
  },
  {
    ...
    description: 'Experience the spiritual soul of India through sacred ghats and Ganga Aarti.',
    highlights: ['Ghat Ceremony', 'Temple Tours', 'Ganges Cruise', 'Local Culture'],
...

  {
    ...
    description: 'Relax beside peaceful lakes and mist-covered valleys in Kodaikanal.',
    highlights: ['Lake Activities', 'Scenic Drives', 'Trekking', 'Adventure Sports'],
  ...
  {
    destination: 'Backwaters & Houseboat',
    country: 'India',
    state: 'Kerala',
    duration: '3 Days / 2 Nights',
    price: '$599',
    ...
    description: 'Enjoy peaceful backwater cruises and authentic Kerala experiences.',
    highlights: ['Houseboat Stay', 'Sunset Cruise', 'Fishing Village', 'Ayurveda'],
  ...
  priceNote: 'per person',
  stars: 4,
  hotel: 'Fort View Palace',
  description: 'Explore the famous Blue City, royal forts, and colorful local markets.',
  highlights: ['Mehrangarh Fort', 'Blue City Tour', 'Clock Tower', 'Local Markets'],
